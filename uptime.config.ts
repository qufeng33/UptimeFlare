...
const workerConfig = {
  ...
  monitors: [
    {
      id: "tencent-singapore",
      name: "Tencent-Singapore-Server",
      method: "TCP_PING",
      target: "43.156.235.182:22",
      tooltip: "Tencent singapore server SSH",
      statusPageLink: "https://nginx.sg.51604550.xyz",
      timeout: 5000,
    },
    {
      id: "home",
      name: "Homelab-Server",
      method: "TCP_PING",
      target: "homelab.51604550.xyz:34567",
      tooltip: "Homelab server SSH",
      statusPageLink: "https://nginx.home.51604550.xyz",
      timeout: 5000,
    },
  ],
  callbacks: {
...
async function notify(
  ...
  let statusText = isUp
    ...
    : `Service became unavailable at ${timeIncidentStartFormatted}. Issue: ${
        reason || "unspecified"
      }`;
